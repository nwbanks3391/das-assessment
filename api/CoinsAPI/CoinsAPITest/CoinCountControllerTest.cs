...
{
    public class CoinCountControllerTest
    {
        [Theory]
        ...
        {
            var pr = new CoinCountProcessor();
            var obj = new CoinCountController(pr);

            var param = new TotalValue() { Value = (decimal)input };

            var result = obj.Post(param);
